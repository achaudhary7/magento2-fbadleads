...
{
    /**
     * Path to store config where count of fblead posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'fblead/view/items_per_page';
    ...
    /**
     * Remove Fblead item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Earth\Fblead\Model\Fblead $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Fblead Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Fblead Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getFbleadPerPage()
    {
